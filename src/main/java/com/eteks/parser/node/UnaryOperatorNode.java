 ...
 * @since Jeks 1.0
 */
public class UnaryOperatorNode extends ConstantNode implements
        ParameterizedNode
{
    ...
    /**
     * Returns the value returned by the <code>getUnaryOperatorValue ()</code>
     * method of <code>interpreter</code> with the key of this operator and the
     * computed value of its operand as parameters.
     * 
     * @param interpreter
     *            runtime interpreter.
