...
public class LiteralNode implements ExpressionNode
{
     ...
     * of <code>interpreter</code> with the stored value of this literal as
     * parameter.
     * 
     * @param interpreter
     *            runtime interpreter.
     ...
     *            not used.
     * @return the interpreted value of this literal. The type of the returned
    ...
    public double computeExpression(double[] parametersValue)
    {
        if (value instanceof Number)
            ...
            throw new IllegalArgumentException("Literal " + value
