...
public class ExpressionParameterNode implements ExpressionNode
{
     ...
     *            the instance of <code>ExpressionParameter</code> that will
     *            return the value of a parameter depending on its key.
     * @param parameterKey
    ...
    /**
     * Returns the instance of <code>ExpressionParameter</code> able to returns
     * the key of a parameter and its value.
     * 
    ...
    /**
     * Returns the value returned by the <code>getParameterValue ()</code>
     * method of <code>interpreter</code> with the returned value of
     * <code>getParameterValue ()</code> with the key of this parameter as
     * argument of <code>getParameterValue ()</code>.
     * 
     * @param interpreter
     *            runtime interpreter.
     * @param parametersValue
     *            not used.
     * @return the interpreted value of this parameter. The type of the returned
    ...
    {
        return interpreter.getParameterValue(expressionParameter
                .getParameterValue(parameterKey));
    }

    /**
     * Returns the double value returned by the
     * <code>getParameterValue ()</code> method of the the
     * <code>ExpressionParameter</code> instance of this parameter and its key
     * as parameter. The <code>getParameterValue ()</code> method must return an
