...
/**
 * Node requiring parameters to compute its value. Operators and functions
 * implement this interface to store their operands or parameters.
 * 
 * @version 1.0
...
{
    /**
     * Adds the node <code>parameter</code> to the list of parameters or
