...
public class ConstantNode implements ExpressionNode
{
     ...
     *            not used.
     * @return the interpreted value of this constant. The type of the returned
     ...
     * <code>FALSE_DOUBLE</code> is returned for the <code>CONSTANT_FALSE</code>
     * constant key, and the value <code>TRUE_DOUBLE</code> is returned for the
     * <code>CONSTANT_TRUE</code> constant key.
     * 
     * @param parametersValue
     *            not used.
    ...
    public double computeExpression(double[] parametersValue)
    {
        if (Syntax.CONSTANT_PI.equals(key))
            ...
            throw new IllegalArgumentException("Constant key " + key
                    + " not implemented");
    }
}
