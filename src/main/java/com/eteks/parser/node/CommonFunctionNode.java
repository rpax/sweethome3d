 ...
 * @since Jeks 1.0
 */
public class CommonFunctionNode extends ConstantNode implements
        ParameterizedNode
{
    ...
    /**
     * Returns the value returned by the <code>getCommonFunctionValue ()</code>
     * method of <code>interpreter</code> with the key of this function and the
     * computed value of its parameter as parameters of
     * <code>getCommonFunctionValue ()</code>.
     * 
     * @param interpreter
     *            runtime interpreter.
