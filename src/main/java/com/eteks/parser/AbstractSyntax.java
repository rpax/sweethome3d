...
/**
 * Class that helps to define the constants, operators, functions and other
 * required elements of a class implementing the <code>Syntax</code> interface.
 ...
 * All the elements of a syntax returned by the getter methods of the
 * <code>Syntax</code> interface are stored in internal fields that can be set
 * with the setter respective methods of this class. Examples :
 * <UL>
 * <LI><code>setBinaryOperatorKey ("+", OPERATOR_ADD)</code> associates the
 * lexical <code>+</code> to the key <code>OPERATOR_ADD</code> of a syntax, so
 * the <code>getBinaryOperatorKey ("+")</code> method will return the key
 * <code>OPERATOR_ADD</code> for the <code>+</code> lexical at parsing time (all
 * the constants, operators and functions are stored in different hashtables
 * associating a string to a syntactic key).</LI>
 * <LI><code>setOpeningBracket ('(')</code> stores the character <code>(</code>,
 * that will be returned by the <code>getOpeningBracket ()</code> method.</LI>
 * </UL>
 * The <code>getDelimiters ()</code> method is implemented in such a way it
 * returns a string containing the white spaces, the brackets, the parameter
 * separator and all the characters of the (unary and binary) operators and the
 * condition parts that are not valid identifiers with the
 * <code>isValidIdentifier ()</code> method.<br>
 * The case sensitivity of the elements of the syntax is set at creation and
 * can't be changed. By default, a syntax isn't case sensitive.
 * 
 * @version 1.0.2
...
public abstract class AbstractSyntax implements Syntax
{
    ...
    {
        return constantKeys.get(isCaseSensitive() ? constant : constant
                .toUpperCase());
    }
     ...
     * 
     * @param constant
     *            a string describing a constant.
     * @param constantKey
     *            a constant key (one of <code>CONSTANT_PI</code>,
     *            <code>CONSTANT_E</code>, <code>CONSTANT_FALSE</code>,
     *            <code>CONSTANT_TRUE</code> or an other user defined key).
     */
    ...
    /**
     * Returns the key matching <code>unaryOperator</code>. The association is
     * made with the <code>setUnaryOperatorKey ()</code> method.
     * 
     * @param unaryOperator
     *            the string to test.
     * @return the key associated with the unary operator
     *         <code>unaryOperator</code>.
     */
    public Object getUnaryOperatorKey(String unaryOperator)
    {
        return unaryOperatorKeys.get(isCaseSensitive() ? unaryOperator
                : unaryOperator.toUpperCase());
    }

    /**
     * Associates the unary operator <code>unaryOperator</code> to the syntactic
     * key <code>unaryOperatorKey</code>.
     * 
     * @param unaryOperator
     *            an unary operator.
     * @param unaryOperatorKey
     *            an unary operator key (one of <code>OPERATOR_POSITIVE</code>,
     *            <code>OPERATOR_OPPOSITE</code>,
     *            <code>OPERATOR_LOGICAL_NOT</code>,
     *            <code>OPERATOR_BITWISE_NOT</code> or an other user defined
     *            key).
     */
    public void setUnaryOperatorKey(String unaryOperator,
    ...
    /**
     * Returns the key matching <code>binaryOperator</code>. The association is
     * made with the <code>setBinaryOperatorKey ()</code> method.
     * 
     * @param binaryOperator
     *            the string to test.
     * @return the key associated with the binary operator
     *         <code>binaryOperator</code>.
     */
    public Object getBinaryOperatorKey(String binaryOperator)
    {
        return binaryOperatorKeys.get(isCaseSensitive() ? binaryOperator
                : binaryOperator.toUpperCase());
    }

    /**
     * Associates the binary operator <code>binaryOperator</code> to the
     * syntactic key <code>binaryOperatorKey</code>.
     * 
     * @param binaryOperator
     *            a binary operator.
     ...
     */
    public void setBinaryOperatorKey(String binaryOperator,
    ...
    /**
     * Returns the key matching <code>conditionPart</code>. The association is
     * made with the <code>setConditionPartKey ()</code> method.
     * 
     * @param conditionPart
     *            the string to test.
     * @return the key associated with the conditional part
     *         <code>conditionPart</code>.
     */
    public Object getConditionPartKey(String conditionPart)
    {
        return conditionPartKeys.get(isCaseSensitive() ? conditionPart
                : conditionPart.toUpperCase());
    }

    /**
     * Returns 2 or 3 depending on whether the syntax using a condition with two
     * or three parts. If a condition part was associated to the key
     * <code>CONDITION_IF</code> with the <code>setConditionPartKey</code>
     * method, it returns 3 otherwise it returns 2.
     * 
     * @return 2 or 3.
     */
    ...
    /**
     * Associates the condition part <code>conditionPart</code> to the syntactic
     * key <code>conditionPartKey</code>.
     * 
     * @param conditionPart
     *            a conditional part.
     * @param conditionPartKey
     *            a conditional part key (one of <code>CONDITION_IF</code>,
     *            <code>CONDITION_THEN</code>, <code>CONDITION_ELSE</code>).
     */
    public void setConditionPartKey(String conditionPart,
    ...
    /**
     * Returns the key matching <code>commonFunction</code>. The association is
     * made with the <code>setCommonFunctionKey ()</code> method.
     * 
     * @param commonFunction
     *            the string to test.
     * @return the key associated with the common function
     *         <code>commonFunction</code>.
     */
    public Object getCommonFunctionKey(String commonFunction)
    {
        return commonFunctionKeys.get(isCaseSensitive() ? commonFunction
                : commonFunction.toUpperCase());
    }

    /**
     * Associates the common function of name <code>commonFunction</code> to the
     * syntax key <code>commonFunctionKey</code>.
     * 
     * @param commonFunction
     *            a function name.
     * @param commonFunctionKey
     *            a common function key (one of <code>FUNCTION_LN</code>,
     *            <code>FUNCTION_LOG</code>, <code>FUNCTION_EXP</code>,
     *            <code>FUNCTION_SQR</code>,... or an other user defined key).
     */
    public void setCommonFunctionKey(String commonFunction,
     ...
     * is <code>functionName</code>. The <code>addFunction ()</code> method
     * records the functions that a user wants to add to a syntax.
     * 
     * @param functionName
     *            the string to test.
     * @return the <code>Function</code> reference of name
     *         <code>functionName</code>.
     */
    public Function getFunction(String functionName)
    {
        return (Function) functions.get(isCaseSensitive() ? functionName
                : functionName.toUpperCase());
    }

    /**
     * Adds <code>function</code> to the recognized functions of this syntax.
     * The name used by the <code>getSyntax ()</code> method is the value
     * returned by <code>function.getName ()</code>.<br>
     * <code>function</code> may be a function previously parsed with
     * <code>FunctionParser</code> or an intance of a Java written class
    ...
    {
        String functionName = isCaseSensitive() ? function.getName() : function
                .getName().toUpperCase();
     ...
     *         <code>setBinaryOperatorPriority ()</code> method or 0 (the lowest
     *         priority).
     */
    ...
    /**
     * Sets the priority of the binary operator matching the key
     * <code>binaryOperatorKey</code>.
     * 
     * @param binaryOperatorKey
     *            a binary operator key.
     * @param priority
     *            a positive value equal to the priority of the operator.
     */
    ...
    /**
     * Sets the string that contains all the delimiters allowed by the syntax as
     * white spaces (tab, spaces,...).
     * 
     * @param whiteSpaces
     *            the white spaces.
     */
    ...
    /**
     * Returns a string containing the white spaces, the brackets, the parameter
     * separator and all the characters of the (unary and binary) operators and
     * the condition parts that are not valid identifiers with the
     * <code>isValidIdentifier ()</code> method.
     * 
     * @return a string containing the set of characters of the syntax that may
     *         be used as delimiters between literals, constants or identifiers.
     ...
     * function of the syntax are case sensitive. This method is used by the
     * parser for tests comparing the name of functions and parameters and also
     * by <code>getConstantKey ()</code>, <code>getUnaryOperatorKey ()</code>,
     * <code>getBinaryOperatorKey ()</code>, <code>getConditionPartKey ()</code>
     * , <code>getCommonFunctionKey ()</code> and <code>getFunction ()</code>
     * and their respective setter methods to compare strings respecting the
     * case sensitivity set at creation of the syntax.<br>
    ...
    /**
     * Sets the capabity of expressions parsed with this syntax to support
     * syntax short cuts.
     * 
     * @param shortSyntax
     *            <code>true</code> to enable the support of short cuts.
    ...
    /**
     * Extracts the number from the expression <code>expression</code> in the
     * string buffer <code>extractedNumber</code>. The parsed number may start
     * with a digit, ., - or + followed with a decimal number and possibly with
     * the letter E and + or - and an integer.
     * 
     * @param expression
     *            the string to parse.
     * @param extractedNumber
     *            the number extracted from <code>expression</code>.
     * @return <code>null</code> if <code>expression</code> doesn't start with a
     *         number or an instance of <code>Double</code> or <code>Long</code>
     *         according to the parsed number.
     */
            ...
            StringBuffer extractedNumber)
    {
        ...
        else if (expLength > 1 && c == '.'
                && (c1 = expression.charAt(1)) >= '0' && c1 <= '9')
        {
            extractedNumber.append(c);
            nbrePoint++;
        } else if (expLength > 1
                && (c == '+' || c == '-')
                && ((c1 = expression.charAt(1)) >= '0' && c1 <= '9' || expLength > 2
                        && c1 == '.'
        ...
        int index = 1;
        for (; index < expLength
                && ((c = expression.charAt(index)) >= '0' && c <= '9' || c == '.'
                        && nbrePoint++ == 0); index++)
            extractedNumber.append(c);
        ...
        if (nbrePoint <= 1
                && index + 1 < expLength
                && ((exponentCharacter = expression.charAt(index)) == 'E' || exponentCharacter == 'e')
                && ((c = expression.charAt(index + 1)) >= '0' && c <= '9' || index + 2 < expLength
                        && (c == '+' || c == '-')
                        ...
                        && c <= '9'))
        {
            ...
            for (index += 2; index < expLength
                    && (c = expression.charAt(index)) >= '0' && c <= '9'; index++)
                extractedNumber.append(c);
        }

        if (nbrePoint > 0 || exponentCharacter == 'E'
                || exponentCharacter == 'e')
