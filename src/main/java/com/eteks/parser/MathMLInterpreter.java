...
/**
 * Runtime interpreter that outputs a MathML 2.0 string. MathML is an
 * application of XML for describing mathematics and is a W3C recommendation
 * available at <A HREF="http://www.w3.org/Math">http://www.w3.org/Math</A>.<br>
 * This class interprets the contants, operators and functions defined in
 * <code>Syntax</code> with their matching elements of MathML. The value of
 * parameters passed to compute an instance of <code>CompiledFunction</code>
 * with this interpreter may be either strings or numbers instances of
 * <code>Number</code>. If they are strings the MathML element &lt;ci&gt; will
 * be used, otherwise the MathML &lt;cn&gt; will be used as these parameters
 * were literals.<br>
 * Examples of output with a <code>MathMLInterpreter</code> : <BLOCKQUOTE>
 * 
 * <PRE>
 ...
 * 
 * // Compile functions
 * CompiledFunction function1 = parser.compileFunction(&quot;f(x) = x &circ; 2 + 2 * x + 1&quot;);
 ...
 *         + function1.computeFunction(interpreter, new Object[]
 *         { new Double(2.2) }));
 * System.out.println(&quot;f(x) =&gt;\n&quot;
 *         + function1.computeFunction(interpreter, function1.getParameters()));
 * System.out.println(&quot;g(y) =&gt;\n&quot;
 *         + function2.computeFunction(interpreter, new Object[]
 *         { &quot;y&quot; }));
 * </PRE>
 * 
 * </BLOCKQUOTE> The output of this examples is : <BLOCKQUOTE>
 * 
 * <PRE>
 * f(2.2) =>
 *  &lt;apply&gt;
 ...
 * </BLOCKQUOTE>
 * 
 * This interpreter supports conditions but doesn't support recursive compiled
 * functions.<br>
...
public class MathMLInterpreter implements Interpreter
{
    ...
    static
    {
        ...
        commonFunctions.put(Syntax.FUNCTION_SQRT,
                "<root/><degree><ci type=\"integer\">2</ci></degree>");
    ...
    /**
     * Returns the MathML element of the literal <code>literal</code>
     * interpreted as a MathML tag. <code>literal</code> must be an instance of
     * <code>Number</code>.
     * 
     * @param literal
     ...
     * <code>parameter</code> must be an instance of <code>Number</code>,
    ...
    /**
     * Returns the MathML element of the constant <code>constantKey</code>.
    ...
    /**
     * Returns the MathML element describing the unary operator
     ...
     * @param operand
     *            the operand (a MathML element).
     * @return the MathML element matching the operation.
     * @throws IllegalArgumentException
     *             if <code>unaryOperatorKey</code> isn't the key of an unary
    ...
    public Object getUnaryOperatorValue(Object unaryOperatorKey, Object operand)
    {
        ...
        String mathMLUnaryOperator = (String) unaryOperators
                .get(unaryOperatorKey);
    ...
    /**
     * Returns the MathML element describing the binary operator
     ...
     * @param operand1
     *            the first operand (a MathML element).
     * @param operand2
     *            the second operand (a MathML element).
     * @return the MathML element matching the operation. The returned value is
     *         an instance of <code>Double</code>, <code>Long</code>,
     *         <code>Boolean</code> or <code>String</code>.
     * @throws IllegalArgumentException
     *             if <code>binaryOperatorKey</code> isn't the key of a binary
     *             operator of <code>Syntax</code>.
     */
    public Object getBinaryOperatorValue(Object binaryOperatorKey,
            Object operand1, Object operand2)
    {
        String mathMLBinaryOperator = (String) binaryOperators
                .get(binaryOperatorKey);
    ...
    /**
     * Returns the MathML element describing the common function
     * <code>commonFunctionKey</code> with the parameter <code>param</code>.
     * <code>commonFunctionKey</code> must be the key of a commomon function of
     * <code>Syntax</code> (one of <code>FUNCTION_LN</code>,
     * <code>FUNCTION_LOG</code>, <code>FUNCTION_EXP</code>,
     * <code>FUNCTION_SQR</code>,...).
     * 
     * @param commonFunctionKey
     *            the key of a common function of <code>Syntax</code>.
     * @param param
     *            the parameter of the function (a MathML element).
     * @return the MathML element of the function.
     * @throws IllegalArgumentException
     *             if <code>commonFunctionKey</code> isn't the key of a commomon
     *             function of <code>Syntax</code>.
     */
    public Object getCommonFunctionValue(Object commonFunctionKey, Object param)
    {
        if (Syntax.FUNCTION_SQR.equals(commonFunctionKey))
            return getBinaryOperatorValue(Syntax.OPERATOR_POWER, param,
                    new Integer(2));

        String mathMLCommonFunction = (String) commonFunctions
                .get(commonFunctionKey);
    ...
    /**
     * Returns the MathML element describing the condition defined by the
     * parameters <code>paramIf</code>, <code>paramThen</code> or
     * <code>paramElse</code>.
     * 
     * @param paramIf
     *            the condition (a MathML element).
     * @param paramThen
     *            the true condition value (a MathML element).
     * @param paramElse
     *            the false condition value (a MathML element).
    ...
    /**
     * Throws an <code>IllegalArgumentException</code> exception because this
     * interpreter can't evaluate values. This method won't be called internally
     * because <code>supportsRecursiveCall ()</code> returns <code>false</code>.
     * 
     * @param condition
     *            the value to test.
     * @throws IllegalArgumentException
     *             because this interpreter can't evaluate values values.
     */
    ...
    /**
     * Returns the MathML element describing the function <code>function</code>
     * call with its parameters <code>parametersValue</code>. As this method
     * returns <code>function.computeFunction (this, parametersValue)</code>, if
     * <code>function</code> is an instance of <code>CompiledFunction</code> it
     * will return the MathML element matching its expression and if
     * <code>function</code> is a Java written function it will return the
     * MathML element returned by the function if the function is able to use
     * this interpreter.
     * 
     * @param function
     *            the function to evaluate.
     * @param parametersValue
     *            the value of function's parameters (MathML elements).
     * @param recursiveCall
        ...
        if (function instanceof CompiledFunction)
        {
            if (!recursiveCall)
                ...
                throw new IllegalArgumentException(
                        "Can't evaluate recursive function "
                                + function.getName());
        } else
            try
            {
                // The Java written functions may be able to use the
                // MathMLInterpreter
                return function.computeFunction(this, parametersValue);
            } catch (IllegalArgumentException e)
            {
                throw new IllegalArgumentException("Can't evaluate function "
                        + function.getName());
            }
    }
}
