...
/**
 * Runtime interpreter operating on instances of wrapping classes. This class
 * overrides the implementation of its <code>DoubleInterpreter</code> super
 * class to return values, instances of the classes <code>Double</code>,
 * <code>Long</code>, <code>Boolean</code>, <code>String</code> or
 * <code>Character</code> according to the operated literal, operator or
 * function. The type required for parameters of the methods of this interpreter
 * depends on the computed operation. Most of them compute numbers and thus
 * require their parameters value to be instances of <code>Number</code> (
 * <code>Double</code>, <code>Integer</code>,...). As no type checking is done
 * during the parsing of functions and expressions, this interpreter suits
 * particularly to fill this lack and compute expressions supposed to respect
 * the Java syntax :
 * <UL>
 * <LI>The value of the literal returned by <code>getLiteralValue ()</code> is
 * an instance of <code>Boolean</code> for the keys
 * <code>Syntax.CONSTANT_FALSE</code> and <code>Syntax.CONSTANT_TRUE</code>.</LI>
 * <LI>The <code>isTrue ()</code> method used for conditions accepts only a
 * <code>Boolean</code> parameter.</LI>
 * <LI>Operators performing comparison return a value of type
 * <code>Boolean</code>.</LI>
 * <LI>Logical operators accepts only <code>Boolean</code> operands.</LI>
 * <LI>Operators computing numbers (keys <code>OPERATOR_ADD</code>,
 * <code>OPERATOR_SUBSTRACT</code>, <code>OPERATOR_MULTIPLY</code>,
 * <code>OPERATOR_DIVIDE</code>, <code>OPERATOR_POWER</code>,
 * <code>OPERATOR_MODULO</code> and <code>OPERATOR_REMAINDER</code>) returns an
 * instance of <code>Long</code> only if both operators are integers (instances
 * of <code>Integer</code> or <code>Long</code>), otherwise the returned value
 * is an instance of <code>Double</code>.
 * <LI>Operators performing bit comparison (keys
 * <code>OPERATOR_BITWISE_...</code>) accepts only <code>Integer</code>,
 * <code>Long</code> or <code>Boolean</code> operands.</LI>
 ...
 * <LI><code>getLiteralValue ()</code> accepts to return instances of
 * <code>String</code> or <code>Character</code>.</code>
 * <LI>If a <code>WrapperInterpreter</code> interpreter is created with its
 * parameter <code>concatenationSupported</code> equal to <code>true</code>, the
 * binary operator of the addition performs string concatenation if one of its
 * operands is an instance of <code>String</code>.</LI>
 * <LI>If a <code>WrapperInterpreter</code> interpreter is created with its
 * parameter <code>integerDivisionSupported</code> equal to <code>true</code>,
 * the binary operator of the division returns an integer if the type of its
 * operand are integers with possible loss of precision.</LI>
 * <LI>If a <code>WrapperInterpreter</code> interpreter is created with its
 * parameter <code>characterOperationSupported</code> equal to <code>true</code>
 * , the unary and binary operators and the common functions (excepted the
 * logical ones) accepts a character (instance of <code>Character</code>) as an
 * integer parameter.</LI>
 * </UL>
 * These features allow to compute the following functions : <BLOCKQUOTE>
 * 
 * <PRE>
 ...
 * Function function2 = parser
 *         .compileFunction(&quot;fact (x) = x &lt;= 0 ? 1 : x * fact (x - 1)&quot;);
 * Function function3 = parser
 *         .compileFunction(&quot;multPow2 (x,power2) = x &lt;&lt; power2&quot;);
 * 
 * // Compute these functions
 * Interpreter interpreter = new WrapperInterpreter();
 * System.out.println(function1.computeFunction(interpreter, new Object[]
 * { new Integer(2001) }));
 * System.out.println(function2.computeFunction(interpreter, new Object[]
 * { new Double(20) }));
 * System.out.println(function2.computeFunction(interpreter, new Object[]
 * { new Long(5) }));
 * System.out.println(function3.computeFunction(interpreter, new Object[]
 * { new Integer(51), new Integer(3) }));
 * </PRE>
 * 
 * </BLOCKQUOTE> The methods of this class are thread safe.
 * 
 * @version 1.0
...
public class WrapperInterpreter extends DoubleInterpreter
{
    ...
    /**
     * Creates an interpreter operating on instances of wrapping classes. By
     * default concatenation, division on integers and operations on characters
     * are supported.
     */
    ...
    /**
     * Creates an interpreter operating on instances of wrapping classes. By
     * default division on integers and operations on characters are supported.
     * 
     * @param concatenationSupported
     *            if equal to <code>true</code>, the binary operator of the
     *            addition performs string concatenation if one of its operands
     *            is an instance of <code>String</code>.
     */
    ...
    /**
     * Creates an interpreter operating on instances of wrapping classes. By
     * default operations on characters are supported.
     * 
     * @param concatenationSupported
     *            if equal to <code>true</code>, the binary operator of the
     *            addition performs string concatenation if one of its operands
     *            is an instance of <code>String</code>.
     * @param integerDivisionSupported
     *            if equal to <code>true</code>, the binary operator of the
     *            division returns an integer if the type of its operand are
     *            integers (meaning 3 / 2 will return 1).
     */
    public WrapperInterpreter(boolean concatenationSupported,
     ...
     *            division returns an integer if the type of its operand are
     *            integers (meaning 3 / 2 will return 1).
     * @param characterOperationSupported
     *            if equal to <code>true</code>, the unary and binary operators
     *            and the common functions (excepted the logical ones) accepts a
     *            character (instance of the class <code>Character</code>) as an
     *            integer parameter.
     */
    public WrapperInterpreter(boolean concatenationSupported,
            boolean integerDivisionSupported,
     ...
     * 
     * @param literal
     *            an instance of <code>Number</code>, <code>String</code> or
     *            <code>Character</code>.
     * @return the value of the literal. The returned value is the object
     *         itself.
    ...
    {
        if (literal instanceof Number || literal instanceof String
                || literal instanceof Character)
            return literal;
        else
            // true and false are constants not literals
            throw new IllegalArgumentException("Literal " + literal
                    + " not an instance of Number, String or Character");
    }

    /**
     * Returns the value of the parameter <code>parameter</code>.
     * <code>parameter</code> may be an instance of <code>Number</code>,
     * <code>String</code>, <code>Character</code> or <code>Boolean</code>.
     * 
     * @param parameter
     *            an instance of <code>Number</code>, <code>String</code>,
     *            <code>Character</code> or <code>Boolean</code>.
     * @return the value of the parameter. The returned value is the object
     *         itself.
     * @throws IllegalArgumentException
    ...
    public Object getParameterValue(Object parameter)
    {
        if (parameter instanceof Number || parameter instanceof String
            ...
            throw new IllegalArgumentException(
                    "Parameter "
                            + parameter
                            + " not an instance of Number, String, Character or Boolean");
    }
     ...
     * @throws IllegalArgumentException
     *             if <code>operand</code> isn't of the good type for the
     *             requested operator or if <code>unaryOperatorKey</code> isn't
     *             the key of an unary operator of <code>Syntax</code>.
     */
    public Object getUnaryOperatorValue(Object unaryOperatorKey, Object operand)
    {
        if (unaryOperatorKey.equals(Syntax.OPERATOR_OPPOSITE))
        {
            if (operand instanceof Integer || operand instanceof Long)
            ...
            else if (operand instanceof Float || operand instanceof Number)
                ...
                throw new IllegalArgumentException("Operand " + operand
                        ...
                        + (characterOperationSupported ? " or Character" : ""));
        ...
        } else if (unaryOperatorKey.equals(Syntax.OPERATOR_LOGICAL_NOT))
        {
            if (!(operand instanceof Boolean))
                throw new IllegalArgumentException("Operand " + operand
                        + " not an instance of Boolean");
            return ((Boolean) operand).booleanValue() ? Boolean.FALSE
                    : Boolean.TRUE;
        } else if (unaryOperatorKey.equals(Syntax.OPERATOR_BITWISE_NOT))
        {
            if (operand instanceof Integer || operand instanceof Long)
                ...
                throw new IllegalArgumentException("Operand" + operand
                        + " not an instance of Integer or Long");
        } else
     ...
     *            the second operand.
     * @return the result of the operation. The returned value is an instance of
     *         <code>Double</code>, <code>Long</code>, <code>Boolean</code> or
     *         <code>String</code>.
     * @throws IllegalArgumentException
     *             if <code>operand1</code> and <code>operand2</code> aren't of
     *             the good type for requested operator or if
            ...
            Object operand1, Object operand2)
    {
        ...
        // If operations on characters are supported, change the type of
        // characters
        // to integers
        ...
        if (binaryOperatorKey.equals(Syntax.OPERATOR_ADD))
        {
            ...
            if (Long.class.equals(getResultClass(operand1, operand2)))
                return new Long(((Number) operand1).longValue()
                        + ((Number) operand2).longValue());
            else
                return new Double(((Number) operand1).doubleValue()
                        + ((Number) operand2).doubleValue());
        ...
        } else if (binaryOperatorKey.equals(Syntax.OPERATOR_POWER))
        {
            checkOperandsInstanceOfNumber(operand1, operand2);
            if (Long.class.equals(getResultClass(operand1, operand2)))
                return new Long((long) Math.pow(
                        ((Number) operand1).longValue(),
                        ((Number) operand2).longValue()));
            else
                return new Double(Math.pow(((Number) operand1).doubleValue(),
                        ((Number) operand2).doubleValue()));
        ...
        } else if (binaryOperatorKey.equals(Syntax.OPERATOR_EQUAL))
        {
            ...
            checkOperandsInstanceOfComparable(operand1, operand2);
            if (operand1 instanceof Number)
                return ((Number) operand1).doubleValue() == ((Number) operand2)
                        .doubleValue() ? Boolean.TRUE : Boolean.FALSE;
            else
                // operand1 and operand2 instanceof Boolean
                return operand1.equals(operand2) ? Boolean.TRUE : Boolean.FALSE;
        } else if (binaryOperatorKey.equals(Syntax.OPERATOR_DIFFERENT))
        {
            ...
            if (operand1 instanceof Number)
                return ((Number) operand1).doubleValue() == ((Number) operand2)
                        .doubleValue() ? Boolean.FALSE : Boolean.TRUE;
            else
                // operand1 and operand2 instanceof Boolean
                return operand1.equals(operand2) ? Boolean.FALSE : Boolean.TRUE;
        } else if (binaryOperatorKey.equals(Syntax.OPERATOR_BITWISE_OR))
        {
            ...
            if (operand1 instanceof Number)
                ...
                // operand1 and operand2 instanceof Boolean
                return ((Boolean) operand1).booleanValue()
                        | ((Boolean) operand2).booleanValue() ? Boolean.TRUE
                        : Boolean.FALSE;
        ...
        } else if (binaryOperatorKey.equals(Syntax.OPERATOR_SHIFT_LEFT))
        {
            ...
            return new Long(
                    ((Number) operand1).longValue() << ((Number) operand2)
                            .longValue());
        ...
        } else if (binaryOperatorKey.equals(Syntax.OPERATOR_GREATER_OR_EQUAL))
        {
            //checkOperandsInstanceOfNumber(operand1, operand2);
            checkOperandsInstanceOfComparable(operand1, operand2);
            return ((Comparable) operand1).compareTo(operand2) > -1 ? Boolean.TRUE : Boolean.FALSE;
            /*
            return ((Number) operand1).doubleValue() >= ((Number) operand2)
                    .doubleValue() ? Boolean.TRUE : Boolean.FALSE;
            */
        ...
        {           
            checkOperandsInstanceOfComparable(operand1, operand2);
            return ((Comparable) operand1).compareTo(operand2) > 0 ? Boolean.TRUE : Boolean.FALSE;
    ...
    private void checkOperandsInstanceOfNumberOrBoolean(Object operand1,
            Object operand2)
    {
        if (!(operand1 instanceof Number) && !(operand1 instanceof Boolean))
            throw new IllegalArgumentException("Operand " + operand1
                    + " not an instance of Number"
                    + (characterOperationSupported ? ", Character" : "")
                    + " or Boolean");
        if (!(operand2 instanceof Number) && !(operand2 instanceof Boolean))
            throw new IllegalArgumentException("Operand " + operand2
                    + " not an instance of Number"
                    + (characterOperationSupported ? ", Character" : "")
                    + " or Boolean");
        if (!(operand1 instanceof Number && operand2 instanceof Number || operand1 instanceof Boolean
                && operand2 instanceof Boolean))
            throw new IllegalArgumentException("Operands " + operand1 + " and "
                    + operand2 + " must be of compatible type");
    }
    
    private void checkOperandsInstanceOfComparable(Object operand1,
            Object operand2)
    {
        if(!(operand1 instanceof Comparable) && !(operand2 instanceof Comparable))
        {
            throw new IllegalArgumentException("Operand " + operand1 + " and " +
                    operand2 + "not an instance of Comparable.");
        }
    }

    private void checkOperandsInstanceOfIntegerLongOrBoolean(Object operand1,
            Object operand2)
    {
        if (!(operand1 instanceof Integer) && !(operand1 instanceof Long)
                && !(operand1 instanceof Boolean))
            throw new IllegalArgumentException("Operand " + operand1
                    + " not an instance of Integer, Long"
                    + (characterOperationSupported ? ", Character" : "")
                    + " or Boolean");
        if (!(operand1 instanceof Integer) && !(operand1 instanceof Long)
                && !(operand2 instanceof Boolean))
    ...
    private void checkOperandsInstanceOfIntegerOrLong(Object operand1,
            Object operand2)
    {
        if (!(operand1 instanceof Integer) && !(operand1 instanceof Long))
            throw new IllegalArgumentException("Operand " + operand1
                    + " not an instance of Integer"
                    + (characterOperationSupported ? ", Character" : "")
                    + " or Long");
        if (!(operand2 instanceof Integer) && !(operand2 instanceof Long))
            throw new IllegalArgumentException("Operand " + operand2
                    + " not an instance of Integer"
                    + (characterOperationSupported ? ", Character" : "")
                    + " or Long");
    ...
    {
        if ((operand1 instanceof Integer || operand1 instanceof Long)
                && (operand2 instanceof Integer || operand2 instanceof Long))
            return Long.class;
        else
            return Double.class;
    }
     ...
     *         <code>Double</code>, <code>Long</code> or <code>Boolean</code>.
     * @throws IllegalArgumentException
     *             if <code>param</code> isn't of the good type for the
     *             requested function or if <code>commonFunctionKey</code> isn't
     *             the key of a commomon function of <code>Syntax</code>.
     */
     ...
     * 
     * @param condition
     *            the value to test (instance of <code>Boolean</code>).
    ...
    public boolean isTrue(Object condition)
    {
        if (condition instanceof Boolean)
            ...
            throw new IllegalArgumentException("Parameter " + condition
                    + " not an instance of Boolean");
    }
}
