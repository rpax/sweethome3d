...
/**
 * Syntax used by parsers for functions and expressions written in PASCAL. This
 * syntax supports the following operators, constants and functions :
 * <UL>
 ...
 * </LI>
 * </UL>
 * The literals may be any decimal or integer number. The operator of assignment
 * is <code>=</code> (there's no statement BEGIN END in the syntax), brackets
 * <code>( )</code> and the separator of parameters <code>,</code>.<br>
