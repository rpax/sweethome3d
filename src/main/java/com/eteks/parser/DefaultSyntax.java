...
/**
 * Default syntax used by parsers for functions and expressions. This syntax
 * supports the following operators, constants and functions :
 * <UL>
 * <LI>Unary operators : <code>+ -</code></LI>
 * <LI>Binary operators : <code>^ * / MOD + -</code> (from the highest to the
 * lowest priority)</LI>
 * <LI>No condition</LI>
 * <LI>Constants : <code>PI FALSE TRUE</code></LI>
 * <LI>Functions :
 * <code>LN LOG EXP SQR SQRT COS SIN TAN ACOS ASIN ATAN COSH SINH TANH INT
 *                     ABS OPP</code>
 * </LI>
 * </UL>
 * The literals may be any decimal or integer number. The operator for
 * assignment is <code>=</code>, brackets <code>( )</code> and the separator of
 ...
 * This syntax isn't case sensitive. A <code>DefaultSyntax</code> object may be
 * modified with the methods of <code>AbstractSyntax</code>.
 * 
 * @version 1.0
...
public class DefaultSyntax extends AbstractSyntax
{
     ...
     * doesn't start with a number. If a number is found at the beginning of
     * <code>expression</code>, this method extracts it in the string buffer
     * <code>extractedLiteral</code>.
     * 
     * @param expression
     *            the string to parse.
     * @param extractedLiteral
     *            the literal extracted from <code>expression</code> identified
     *            as a valid number with the <code>getLiteralNumber ()</code>
     *            method of the <code>AbstractSyntax</code> class. This string
     *            buffer is emptied before the call of this method by the
     *            parser.
     * @return the value of the extracted number or <code>null</code> if
     *         <code>expression</code> doesn't start with a number.
    ...
    /**
     * Returns <code>true</code> if <code>character</code> is a letter. By
     * default letters are limited to ASCII letters (a to z or A to Z). Override
     * this method to have a syntax with a richer set of letters.
     * 
     * @param character
     *            a char to test.
     * @return <code>true</code> if <code>character</code> is an ASCII letter (a
     *         to z or A to Z).
     */
    ...
    /**
     * Returns <code>true</code> if <code>character</code> is a digit. By
     * default digits are limited to ASCII digits (1 to 9). Override this method
     * to have a syntax with a richer set of digits.
     * 
     * @param character
     *            a char to test.
     * @return <code>true</code> if <code>character</code> is an ASCII digit (1
     *         to 9).
     */
