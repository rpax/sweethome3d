...
/**
 * Exception thrown during the parsing of functions and expressions. This class
 * stores the number of an error matching the type of the detected error, the
 * character index in the parsed string where the error was found and eventually
 * the lexical that caused the exception.
 * 
 * @version 1.0
...
public class CompilationException extends Exception
{
    ...
    public final static int NO_FIELDS_REF = 17;

    private final static String errors[] =
    { "Opening bracket expected", "Invalid function name", "Reserved word",
            "Function name already exists", "Closing bracket expected",
            "Assign operator expected", "Invalid parameter name",
            "Duplicated parameter name", "Syntax error",
            "Closing bracket without opening bracket", "Unknown indentifier",
            "Missing parameters in function call",
            "Invalid parameters count in function call",
            "Then operator expected", "Else operator expected",
            "Then operator without if operator",
            "Else operator without if then operator", "No Fields Referenced" };
     ...
     * 
     * @param errorNumber
     *            the detected error (one of the contants of this class).
     * @param characterIndex
     *            the character index in the parsed string where the error was
     *            detected.
     */
    ...
    {
        super(errors[errorNumber] + " (" + extractedString + ") at index "
                + characterIndex);
        this.errorNumber = errorNumber;
        this.characterIndex = characterIndex;
     ...
     * 
     * @return the number of the error of this exception (one of of the contants
     *         of this class).
     */
    ...
    /**
     * Returns the character index in the parsed string where the error
     * happened.
     * 
    ...
    /**
     * Returns the invalid string (an invalid identifier or an other string) of
     * this exception.
     * 
     * @return the invalid string or <code>null</code> if no string is involved
     *         for this exception.
     */
